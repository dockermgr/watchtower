...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
__show_post_message() {
  printf_blue 'To use api: curl -q -LSsf -H "Authorization: Bearer '$CONTAINER_USER_ADMIN_PASS_HASH'" '$NGNIX_REVERSE_ADDRESS/v1/update''
  return 0
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Clean up variables
[ -n "$CONTAINER_COMMANDS" ] && CONTAINER_COMMANDS="$(echo "$CONTAINER_COMMANDS" | tr '\n' ' ')" || CONTAINER_COMMANDS="   "
