...
HOST_CRON_COMMAND='curl -q -LSsf -H \"Authorization: Bearer ${CONTAINER_USER_ADMIN_PASS_HASH:-$(__password 32)}\" $CONTAINER_WEB_SERVER_LISTEN_ON:$CONTAINER_WEB_SERVER_INT_PORT/v1/update'
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
